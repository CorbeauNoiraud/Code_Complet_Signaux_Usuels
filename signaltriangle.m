...
close all
%*******************************************************************************
%Script d'un signal triangle à partir d'un signal harmonique fondamental
%INPUT: A = amplitude
...
%tracer graphe 3d
mesh(M2)
title(['Signal en fonction du nombre des harmoniques et du temps'])
xlabel('temps en (s)')
...
set(ZB,'fontsize',7,'position',[0.5000 -0.65 -1])
ylabel(['y = ',num2str(A),'*sin(2*pi*',num2str(f0),'*t)'])
...
set(ZC,'fontsize',7,'position',[0.5000 -0.65 -1])
ylabel(['y = ',num2str(A),'*sin(2*pi*',num2str(f0),'*t)'])
...
set(ZD,'fontsize',7,'position',[60.0001 -0.66 -1.0000])
ylabel(['y = ',num2str(A),'*sin(2*pi*',num2str(f0),'*t)'])
